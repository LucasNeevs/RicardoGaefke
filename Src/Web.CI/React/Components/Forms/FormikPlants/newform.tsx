...
import { internationalization } from './newForm.validation';

const MyFormikForm = (): React.ReactElement<any> => {
  ...
  return(
    <>
      <Formik
        ...
        validationSchema={internationalization(language)}
      >
        {({ 
          values, 
          touched,
